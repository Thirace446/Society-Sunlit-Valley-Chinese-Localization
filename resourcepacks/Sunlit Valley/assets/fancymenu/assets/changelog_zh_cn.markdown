...
--- 
- 完整更新日志请将游戏语言切换为英语
- 新增销售点和子账户（来自 Create Numismatics 更新）
- 为金币排行榜添加数字截断显示
- 移除溢出令牌的购买，因为 Numismatics 团队已修复溢出 Bug！令牌仍可使用
- 移除 Waterframes 模组，并移除整合包中的所有与它有关的配方，以便玩家可以安全地从整合包中删除它
- 为咖啡厅顾客添加细身皮肤模型渲染
- 拥有方块形态的食物在摆盘后将以 3D 形式渲染
- 修复弩箭与画的贴图错误
- 修复部分日志信息意外显示的问题
- 修复部分树苗缺少标签的问题
- 修复金币排行榜在特定情况下显示空白的问题
- 修复银行账户超过 20 亿时溢出为负 20 亿的问题
- 修复仅含甜点的咖啡厅出现脏盘子的问题
